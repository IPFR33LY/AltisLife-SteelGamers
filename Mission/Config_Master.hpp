...
class VirtualItems {
	...
	VITEMMACRO(fuelEmpty, "STR_Item_FuelE", "fuelEmpty", 2, -1, -1, false, -1, "sg_pack01\sg_icons\items\fuelempty.paa")
	VITEMMACRO(fuelFull, "STR_Item_FuelF", "fuelFull", 5, 850, 500, false, -1, "sg_pack01\sg_icons\items\fuel_can.paa")
	VITEMMACRO(spikeStrip, "STR_Item_SpikeStrip", "spikeStrip", 15, 2500, 1200, false, -1, "\sg_icons\items\spikestrip.paa")
	VITEMMACRO(lockpick, "STR_Item_Lockpick", "lockpick", 1, 150, 75, false, -1, "sg_pack01\sg_icons\items\lockpick.paa")
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldbar", 12, -1, 95000, false, -1, "sg_pack01\sg_icons\items\goldbar.paa")
	VITEMMACRO(blastingcharge, "STR_Item_BCharge", "blastingCharge", 15, 35000, -1, true, -1, "sg_pack01\sg_icons\items\blastingcharge.paa")
	VITEMMACRO(boltcutter, "STR_Item_BCutter", "boltCutter", 5, 7500, -1, true, -1, "sg_pack01\sg_icons\items\boltcutter.paa")
	VITEMMACRO(defusekit, "STR_Item_DefuseKit", "defuseKit", 2, 2500, -1, false, -1, "sg_pack01\sg_icons\items\defusekit.paa")
	VITEMMACRO(storagesmall, "STR_Item_StorageBS", "storageSmall", 5, 75000, -1, false, -1, "sg_pack01\sg_icons\items\storageSmall.paa")
	VITEMMACRO(storagebig, "STR_Item_StorageBL", "storageBig", 10, 150000, -1, false, -1, "sg_pack01\sg_icons\items\storageBig.paa")

	//Mined Items
	VITEMMACRO(oil_unprocessed, "STR_Item_OilU", "oilUnprocessed", 7, -1, -1, false, -1, "sg_pack01\sg_icons\items\oil_unprocessed.paa")
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 6, -1, 3200, false, -1, "sg_pack01\sg_icons\items\oil_processed.paa")
	...
	VITEMMACRO(uranium, "STR_Item_Uranium", "uranium", 6, -1, 1950, false, -1, "")
	VITEMMACRO(uraniumu, "STR_Item_Uraniumu", "uraniumu", 5, -1, 1950, false, -1, "")
	VITEMMACRO(uraniumt, "STR_Item_Uraniumt", "uraniumt", 3, -1, 5000, false, -1, "")
	...
	VITEMMACRO(marijuana, "STR_Item_Marijuana", "marijuana", 3, 7500, 2350, true, -1, "icons\ico_marijuana.paa")
	...
	VITEMMACRO(meth, "STR_Item_Meth", "meth", 4, -1, 5000, true, -1, "")
	VITEMMACRO(methu, "STR_Item_Methu", "methu", 4, -1, 5000, true, -1, "")	
	VITEMMACRO(plutonium, "STR_Item_Plutonium", "plutonium", 45, -1, 1500000, true, -1, "")
	...
	VITEMMACRO(peach, "STR_Item_Peach", "peach", 1, 95, 55, false, 10, "icons\food.paa")
	...
	VITEMMACRO(gpstracker, "STR_Item_gpstracker", "gpstracker", 2, 2000, 1350, false, 100, "")	
};
