class WeaponShops {
    ...
    class rebel_lvl_2 {
        ...
        items[] = {
			...
			{ "hgun_mas_sa61_F", "SA61 Skorpion", 85000 },
            { "20Rnd_mas_765x17_Mag", "Munitions SA61", 200 },
			{ "srifle_GM6_camo_F", "Lynx CAMO", 105000 },
	...
	class criminel {
        ...
        items[] = {
            ...
            { "150Rnd_762x54_Box", "Munitions Zafir 7.62", 200 },
			{ "hlc_optic_kobra", "Lunette Kobra", 2500 },
			{ "hgun_mas_acp_F", "1911 ACP", 2500 },
            { "12Rnd_mas_45acp_Mag", "Munitions 1911ACP", 150 },
			{ "hgun_mas_mak_F", "Makarov", 2000 },
            { "8Rnd_mas_9x18_Mag", "Munitions Makarov", 150 },
            { "FHQ_optic_MicroCCO", "", 1200 },
