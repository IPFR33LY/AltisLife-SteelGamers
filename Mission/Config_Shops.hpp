class WeaponShops {
    ...
    class rebel_lvl_2 {
        ...
        items[] = {
			...
			{ "hgun_mas_sa61_F", "SA61 Skorpion", 85000 },
            { "20Rnd_mas_765x17_Mag", "Munitions SA61", 200 },
			{ "hgun_mas_sa61_F", "Lynx CAMO", 105000 },
            { "srifle_GM6_camo_F", "Munitions Lynx", 200 },
			{ "arifle_mas_m70", "M70", 110000 },
            { "30Rnd_mas_762x39_mag", "Munitions M70", 200 },
