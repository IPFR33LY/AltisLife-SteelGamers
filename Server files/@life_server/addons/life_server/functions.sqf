...
private[""_msg"",""_to""];
	...
	hint format[""Tu as envoyé un message aux Médecin/Pompiers."",_to,_msg];
	ctrlShow[3022,true];
";
//To One Person
...
compileFinal "
	...
	ctrlShow[3015,false];
	_msg = ctrlText 3003;
	if(lbCurSel 3004 == -1) exitWith {hint ""Vous devez sélectionner un joueur pour envoyez le message !""; ctrlShow[3015,true];};
	...
	[] call life_fnc_cellphone;
	hint format[""Tu as envoyé %1 un message: %2"",name _to,_msg];
	ctrlShow[3015,true];
";
//To All Cops
...
compileFinal "
	...
	[] call life_fnc_cellphone;
	hint format[""Tu as envoyé %1 un message: %2"",_to,_msg];
	ctrlShow[3016,true];
";
//To All Admins
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 1 :
		{
			...
			private[""_message""];
			_message = format[""--RAPPORT DE GENDARMERIE DE %1: %2"",_from,_msg];
			hint parseText format [""<t color='#316dff'><t size='2'><t align='center'>Nouveau Rapport<br/><br/><t color='#33CC33'><t align='left'><t size='1'>à: <t color='#ffffff'>Gendarmerie<br/><t color='#33CC33'>De: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			[""PoliceDispatch"",[format[""Un nouveau rapport de: %1"",_from]]] call bis_fnc_showNotification;
			player say3D ""message"";
			systemChat _message;
		};
		...
		case 3 :
		{
			...
			hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Message Admin<br/><br/><t color='#33CC33'><t align='left'><t size='1'>à: <t color='#ffffff'>Vous<br/><t color='#33CC33'>De: <t color='#ffffff'>An Admin<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%1"",_msg];
		...
		case 4 :
		{
			...
			_message = format[""!!!MESSAGE ADMIN: %1"",_msg];
			_admin = format[""Envoyé par l'Admin: %1"", _from];
			hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Message Admin<br/><br/><t color='#33CC33'><t align='left'><t size='1'>à: <t color='#ffffff'>Tout le Monde<br/><t color='#33CC33'>De: <t color='#ffffff'>The Admins<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%1"",_msg];
		...
		case 5: {
			private[""_message""];
			_message = format[""!!!DEMANDE DE MEDECIN: %1"",_msg];
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Demande de Médecin<br/><br/><t color='#33CC33'><t align='left'><t size='1'>à: <t color='#ffffff'>Vous<br/><t color='#33CC33'>De: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			player say3D ""message"";
			[""TextMessage"",[format[""Demande de Médecin De %1"",_from]]] call bis_fnc_showNotification;
		};
	};
";
