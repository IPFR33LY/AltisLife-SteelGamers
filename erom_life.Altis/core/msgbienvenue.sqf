...
_welcomeMessage = format["Bienvenue sur Steel Gamers Life Mod %1",format["%1", name player]];
_camDistance = 40;
...
_role2 = "Site WEB";
_role2names = ["www.steel-gamers.com"];
_role3 = "TeamSpeak 3";
_role3names = ["tsaltis.steel-gamers.com"];
_role4 = "Attention";
_role4names = ["Serveur Rôle Play - Pas de Freekill"];
_role5 = "Merci de lire";
_role5names = ["Les règles sont sur le Site, Merci d'en prendre connaissance. Bon jeu a tous !"];
