...
class Licenses {
    ...
    class donateur_lvl_1 {
        variable = "donateur_lvl_1";
        displayName = "STR_License_Donateur";
        price = 15450000;
        illegal = false;
        side = "civ";
    };	
    ...
    class donateur_lvl_2 {
        variable = "donateur_lvl_2";
        displayName = "STR_License_Donateur2";
        price = 15450000;
        illegal = false;
        side = "civ";
    };	
    ...
    class donateur_lvl_3 {
        variable = "donateur_lvl_3";
        displayName = "STR_License_Donateur3";
        price = 15450000;
        illegal = false;
        side = "civ";
    };	
    ...
    class rebel_lvl_2 {
        variable = "rebel_lvl_2";
        displayName = "STR_License_Rebel2";
        price = 75000;
        illegal = true;
        side = "civ";
    };
    ...
    class rebel_lvl_3 {
        variable = "rebel_lvl_3";
        displayName = "STR_License_Rebel3";
        price = 75000;
        illegal = true;
        side = "civ";
    };
    ...
    class rebel_lvl_4 {
        variable = "rebel_lvl_4";
        displayName = "STR_License_Rebel4";
        price = 75000;
        illegal = true;
        side = "civ";
    };
    ...
    class rebel_lvl_5 {
        variable = "rebel_lvl_5";
        displayName = "STR_License_Rebel5";
        price = 75000;
        illegal = true;
        side = "civ";
    };
    ...
    class criminel {
        variable = "criminel";
        displayName = "STR_License_Criminel";
        price = 250000;
        illegal = true;
        side = "civ";
    };
    ...
    class pompier {
        variable = "pompier";
        displayName = "STR_License_Pompier";
        price = 1500000;
        illegal = false;
        side = "med";
    };
