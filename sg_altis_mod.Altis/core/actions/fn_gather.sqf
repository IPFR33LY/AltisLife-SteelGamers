...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","uranium_1","coffee_1","coffee_2","coffee_3","rye_1","hops_1","yeast_1","artefact_area_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["coffee_1","coffee_2","coffee_3"]): {_gather = ["coffee",2];};	
